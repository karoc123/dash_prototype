...
// BASE URL
define("BASEURL", "http://xxxxxxxxxx.de/dash/");

// Falls Debugging gewünscht ist
define("DEBUG", TRUE);
IF(DEBUG) 
{
 ...
 */
define("COOKIE_RUNTIME", 2409600);
define("COOKIE_DOMAIN", ".xxxxx.de");
define("COOKIE_SECRET_KEY", "xxxxxxxxx");
